...
class WithRefreshHome extends StatefulWidget {
  const WithRefreshHome({super.key});

  @override
  State<WithRefreshHome> createState() => _WithRefreshHomeState();
}

class _WithRefreshHomeState extends State<WithRefreshHome> {
  @override
